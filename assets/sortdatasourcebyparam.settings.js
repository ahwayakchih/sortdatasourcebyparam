...
(function($) {
	...
	$(document).ready(function() {
		...
		form.on('change', 'input[name="fields\\[sortInput\\]"], input[name="fields\\[orderInput\\]"]', function(event) {
		...
		form.on('change', 'select[name="fields\\[sort\\]"], select[name="fields\\[order\\]"]', function(event) {
